...
const Messages = () => {
  ...
  const handleConversationClick = (conversation) => {
    ...
    if (conversation.provider_id) {
      navigate(`/chat/${conversation.provider_id}`)
    }
  }
      ...
      <div className="messages-list">
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <p className="empty-state-hint">Start a conversation with an expert!</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="conversation-info">
                  <div className="conversation-header">
                    <h3 className="conversation-name">{provider?.name || 'Provider'}</h3>
                    {lastMessage && (
